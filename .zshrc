...
# ALIAS
alias sudo='sudo '
alias secl='find /usr/share/wordlists/seclists/'
alias ffuf='/usr/bin/ffuf -c'
alias dl='cd ~/Downloads'
alias lxcpg='sudo /opt/scripts/lxc/init_throw_away'
...
# Created by `pipx` on 2024-01-29 13:14:13
